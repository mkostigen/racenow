...
unversioned_jmask_file = File.open(JMASK_FILE, 'rb', &:read)
...
[BOWER_MANIFEST_FILE, NPM_MANIFEST_FILE, COMPONENT_MANIFEST_FILE, METEOR_MANIFEST_FILE].each do |manifest_name|
  puts "# UPGRADING #{manifest_name} "
  manifest_file = File.open(manifest_name, 'rb', &:read)
...
File.open(JMASK_FILE, 'r') do |_file|
